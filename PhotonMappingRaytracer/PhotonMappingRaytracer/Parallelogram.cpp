...
bool Parallelogram::hit(const Ray& r, float tmin, float tmax, 
...
BBox Parallelogram::boundingBox() const
{
...
bool Parallelogram::randomPoint(const Vector3& viewpoint, const Vector2& seed, 
      Vector3& light_point, Vector3& N, float & pdf, 
      rgb& radiance) const
{
...
bool Parallelogram::generatePhoton(Ray & ray, const Vector2 & seed1, const Vector2 & seed2)
{
   Vector3 point;
   Vector3 direction;
