...
bool Sphere::hit(const Ray& r, float tmin, float tmax, SurfaceHitRecord& rec)const 
{
...
bool Sphere::randomPoint(const Vector3& viewpoint, const Vector2& aseed, 
      Vector3& on_light, Vector3& N, float& pdf, rgb& E)const  
{
   ...
   do {
      ...
      if (this->hit(to_light, 0.00001, FLT_MAX, rec)) {
           on_light = rec.p;
