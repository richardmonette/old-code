...
typedef struct Photon 
{
	...
	unsigned char s_theta, s_phi;   // normal of the surface on which the photon is stored
} Photon;
...
public:
	...
	void store(const float power[3],				// photon power
	           ...
	           const float s_dir[3]);				// normal of the surface on which the photon is stored
