...
bool DiffuseMaterial::scatterDirection (const Vector3& in_dir, const SurfaceHitRecord& rec, Vector2& seed, rgb& color, bool& CEL, float& brdf, Vector3& v_out)
{
	ONB uvw    = rec.uvw;
	Vector3 p  = rec.p;
	Vector2 uv = rec.uv;
...
bool DiffuseMaterial::transmitDirection(const Vector3& in_dir,
