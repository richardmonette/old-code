...
{	
	...
	{		
		...
		// vert 0
			...
			verts[0].position = verts[0].position * cameraMatrix;
		...
		// vert 1
			...
			verts[1].position = verts[1].position * cameraMatrix;
		...
		// vert 2
			...
			verts[2].position = verts[2].position * cameraMatrix;
		...
		if ( ( (zClipCodes[0] | zClipCodes[1] | zClipCodes[2]) & CLIP_CODE_LZ) )
		{
			if (numVertsIn == 1) // NICE CASE NO NEW VERTICES
			{
				...
				verts[v0].position = verts[v0].position * projectionMatrix;
				verts[v1].position = verts[v1].position * projectionMatrix;
				verts[v2].position = verts[v2].position * projectionMatrix;

				verts[v0].invz = 1.0f / verts[v0].position.z;
				verts[v1].invz = 1.0f / verts[v1].position.z;
				verts[v2].invz = 1.0f / verts[v2].position.z;

				verts[v0].position *= 1.0f / verts[v0].position.w;
				verts[v1].position *= 1.0f / verts[v1].position.w;
				verts[v2].position *= 1.0f / verts[v2].position.w;

				verts[v0].position = verts[v0].position * screenMatrix;
				verts[v1].position = verts[v1].position * screenMatrix;
				verts[v2].position = verts[v2].position * screenMatrix;
			...
			else if (numVertsIn == 2)
			{
				...
				temp_poly[v0].position = temp_poly[v0].position * projectionMatrix;
				temp_poly[v1].position = temp_poly[v1].position * projectionMatrix;
				temp_poly[v2].position = temp_poly[v2].position * projectionMatrix;
				...
				temp_poly[v0].position *= 1.0f / temp_poly[v0].position.w;
				temp_poly[v1].position *= 1.0f / temp_poly[v1].position.w;
				temp_poly[v2].position *= 1.0f / temp_poly[v2].position.w;

				temp_poly[v0].position = temp_poly[v0].position * screenMatrix;
				temp_poly[v1].position = temp_poly[v1].position * screenMatrix;
				temp_poly[v2].position = temp_poly[v2].position * screenMatrix;
		...
		{
			verts[0].position = verts[0].position * projectionMatrix;
			verts[1].position = verts[1].position * projectionMatrix;
			verts[2].position = verts[2].position * projectionMatrix;

			verts[0].invz = 1.0f / verts[0].position.z;
			verts[1].invz = 1.0f / verts[1].position.z;
			verts[2].invz = 1.0f / verts[2].position.z;

			verts[0].position *= 1.0f / verts[0].position.w;
			verts[1].position *= 1.0f / verts[1].position.w;
			verts[2].position *= 1.0f / verts[2].position.w;

			verts[0].position = verts[0].position * screenMatrix;
			verts[1].position = verts[1].position * screenMatrix;
			verts[2].position = verts[2].position * screenMatrix;
